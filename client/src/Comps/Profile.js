   ...
   return (
      <div className="container" style={{ margin: '0px auto' }}>
         <div style={styleDiv}>
            ...
            <div>
               <h5 style={{ textAlign: "center", marginTop: '30px' }}>{state ? (state.firstname + ' ' + state.lastname) : 'Loading..'}</h5>
            ...
            {mypictures.map(picture => {
               return (
                  <div className="col s12 m6 l4">
                     <img key={picture._id} alt={picture.title} src={picture.picture} style={{ width: '400px' }} className="responsive-img card materialBox hoverable" />
                  </div>
               )
            })}
         </div>
